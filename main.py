...
logging.basicConfig(filemode="sample.log",
...
def dowload(title, video_url):
    ydl_opts = {'outtmpl': '{}.%(ext)s'.format(title), 'format': 'bestaudio/best', 'postprocessors': [
...
def music(bot, update):
    ...
    music_dict = dowload(title, video_url)
...
def main():
    u = Updater('987385755:AAEwvPItlWtmgK_iELZWs-Stl785w6EsnlA')
    dp = u.dispatcher
